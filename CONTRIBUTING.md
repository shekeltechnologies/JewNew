Contributing to Shekel Core
============================

The Shekel Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Shekel Core project, and is not to be
confused with overall Shekel Network Protocol consensus changes.

Whether a pull request is merged into Shekel Core rests with the project merge
...
Patches that change Shekel consensus rules are considerably more involved than
...
Where a patch set proposes to change the Shekel consensus, it must have been
...
The project leader is the release manager for each Shekel Core release.
