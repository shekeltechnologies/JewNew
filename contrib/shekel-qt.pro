...
RESOURCES += src/qt/shekel.qrc src/qt/shekel_locale.qrc

TRANSLATIONS += src/qt/locale/shekel_bg.ts \
                src/qt/locale/shekel_de.ts \
                src/qt/locale/shekel_en.ts \
                src/qt/locale/shekel_es.ts \
                src/qt/locale/shekel_fi.ts \
                src/qt/locale/shekel_fr.ts \
                src/qt/locale/shekel_it.ts \
                src/qt/locale/shekel_ja.ts \
                src/qt/locale/shekel_pl.ts \
                src/qt/locale/shekel_pt.ts \
                src/qt/locale/shekel_ru.ts \
                src/qt/locale/shekel_sk.ts \
                src/qt/locale/shekel_sv.ts \
                src/qt/locale/shekel_vi.ts \
                src/qt/locale/shekel_zh_CN.ts \
                src/qt/locale/shekel_zh_TW.ts
