...
*Setup instructions for a gitian build of Shekel using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Shekel
...
- [Building Shekel](#building-shekel)
...
To build Shekel (for Linux, OSX and Windows) just follow the steps under 'perform
...
```bash
    ...
    From https://github.com/eastcoastcrypto/Shekel
...
For example:
```bash
URL=https://github.com/eastcoastcrypto/Shekel.git
