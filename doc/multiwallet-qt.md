...
In order to support loading of multiple wallets in shekel-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is shekel.cpp.
...
Changes to shekel.cpp
----------------------
shekel.cpp is the entry point into shekel-qt, and as such, will require some minor modifications to provide hooks for
