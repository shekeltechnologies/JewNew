...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"shekel", "listmasternodes", &listmasternodes, true, true, false},
        {"shekel", "getmasternodecount", &getmasternodecount, true, true, false},
        {"shekel", "masternodeconnect", &masternodeconnect, true, true, false},
        {"shekel", "masternodecurrent", &masternodecurrent, true, true, false},
        {"shekel", "masternodedebug", &masternodedebug, true, true, false},
        {"shekel", "startmasternode", &startmasternode, true, true, false},
        {"shekel", "createmasternodekey", &createmasternodekey, true, true, false},
        {"shekel", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"shekel", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"shekel", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"shekel", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"shekel", "getmasternodescores", &getmasternodescores, true, true, false},
        {"shekel", "mnbudget", &mnbudget, true, true, false},
        {"shekel", "preparebudget", &preparebudget, true, true, false},
        {"shekel", "submitbudget", &submitbudget, true, true, false},
        {"shekel", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"shekel", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"shekel", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"shekel", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"shekel", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"shekel", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"shekel", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"shekel", "checkbudgets", &checkbudgets, true, true, false},
        {"shekel", "mnsync", &mnsync, true, true, false},
        {"shekel", "spork", &spork, true, true, false},
        {"shekel", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
