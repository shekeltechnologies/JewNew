...
// Possible states for zJEW send
enum ZerocoinSpendStatus {
    ZJEW_SPEND_OKAY = 0,                            // No error
    ZJEW_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZJEW_WALLET_LOCKED = 2,                         // Wallet was locked
    ZJEW_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZJEW_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZJEW_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZJEW_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZJEW_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZJEW_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZJEW_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZJEW_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZJEW_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZJEW_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZJEW_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZJEW_SPENT_USED_ZJEW = 14                       // Coin has already been spend
};
